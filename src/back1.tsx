...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FFFFFF] text-[#111111] overflow-x-hidden select-none pb-16 lg:pb-0 font-sans">
      ...
      {/* ================= GIANT CANVAS TEXT LAYER (Layered Behind Character) ================= */}
      <div className="absolute inset-0 z-0 flex flex-col justify-center items-center pointer-events-none select-none overflow-hidden">
        <h1 className="text-[15vw] font-brush text-[#FF2E16] uppercase leading-none select-none tracking-tight text-glow-red select-none">
          YOR FORGER
        </h1>
      </div>
