...
function App() {
  ...
  const characterImages = {
    ...
    arsenal: "https://f.top4top.io/p_38484snzk1.png", // Weapons Ready
  ...
  // Real-time Scroll Listener for Interface Transitions
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#FFFFFF] text-[#111111] overflow-x-hidden select-none font-sans scroll-smooth">
      ...
      <style>{`
        ...
        {/* 3D Silhouette Drop-Shadow Merah untuk Main Character */}
        .char-shadow-filter {
      ...
      <div className={`fixed inset-0 bg-white/98 backdrop-blur-md z-40 flex flex-col justify-center items-center transition-all duration-500 ease-in-out ${
        ...
        <div className="text-stone-400 text-[9px] font-cyber tracking-[0.4em] mb-12 animate-pulse text-center bg-gray-200 rounded-2xl p-1.5">
          — OCHYY x YORR —
        </div>
      ...
      <div className="relative min-h-screen w-full flex flex-col justify-between">
        ...
        {/* THE MAIN HERO ARTWORK (Karakter diperbesar pada mobile + Shadow merah diaktifkan) */}
        <div className={`absolute inset-0 z-10 flex justify-center items-start pt-[14vh] sm:items-center sm:pt-0 pointer-events-none px-6 overflow-hidden transition-all duration-1000 ease-in-out ${
          ...
          <div 
            key={activeSection} 
            className="relative w-[92vw] sm:w-auto h-[58vh] mt- sm:h-[75vh] lg:h-[88vh] bg-transparent p-0 border-0 shadow-none animate-float-char flex justify-center items-center transition-all duration-500 origin-center"
          >
            <img
              src={characterImages[activeSection]}
              alt={`Yor Artwork ${activeSection}`}
              className="h-full w-full sm:w-auto object-contain char-shadow-filter select-none transition-all duration-500 mix-blend-normal sm:mix-blend-multiply"
            />
          </div>
        </div>

        {/* Content Interface Overlay */}
        <main key={activeSection} className={`relative z-20 w-full min-h-screen pt-24 sm:pt-28 lg:pt-36 px-4 sm:px-8 lg:px-12 flex flex-col justify-between transition-all duration-700 ease-in-out ${
          isScrolledDown ? '-translate-y-12 opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'
        }`}>
          
          {/* Spacer khusus mobile yang disesuaikan dengan tinggi baru main character artwork */}
          <div className="lg:hidden h-[56vh] pointer-events-none"></div>

          {/* SECTION 1: PROFILE */}
          {activeSection === 'profile' && (
            <div className="animate-page-profile grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-4 items-start w-full my-auto z-20 pb-12 lg:pb-0">
              
              {/* Left Column (Bio 1) */}
              <div className="col-span-12 lg:col-span-4 space-y-4 bg-white/90 sm:bg-transparent backdrop-blur-xs sm:backdrop-blur-none p-4 sm:p-0 border border-stone-200/60 sm:border-0 shadow-xs sm:shadow-none rounded-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="border border-stone-200 p-0.5 bg-white inline-block w-44 shadow-xs">
                    <img src={cropStripLeft} alt="Portrait Strip Left" className="w-full h-12 object-cover grayscale contrast-125" />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 pt-1">
                  <span className="font-cyber font-black text-[10px] tracking-wider text-stone-900">YOR x CHYY</span>
                  <div className="w-12 h-[1px] bg-stone-900"></div>
                </div>
              </div>
              
              {/* Right Column (Bio 2 & Clock) */}
              <div className="col-span-12 lg:col-span-4 lg:col-start-9 flex flex-col items-start lg:items-end space-y-4 lg:text-right bg-white/90 sm:bg-transparent backdrop-blur-xs sm:backdrop-blur-none p-4 sm:p-0 border border-stone-200/60 sm:border-0 shadow-xs sm:shadow-none rounded-sm">
                <div className="font-cyber font-black text-2xl sm:text-3xl tracking-widest text-[#111111] self-start lg:self-auto select-none">
                  21:39
                </div>
          ...
          {activeSection === 'skills' && (
            <div className="animate-page-skills grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start w-full my-auto z-20 pb-12 lg:pb-0">
              ...
              <div className="col-span-12 lg:col-span-4 lg:col-start-9 max-w-xs lg:text-right bg-white/90 backdrop-blur-xs p-4 border border-stone-200/60 shadow-xs ml-auto lg:ml-0 rounded-sm">
          ...
          {activeSection === 'arsenal' && (
            <div className="animate-page-arsenal grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start w-full my-auto z-20 pb-12 lg:pb-0">
              <div className="col-span-12 lg:col-span-4 space-y-3 max-w-xs">
                <div className="border-l-2 border-[#FF2E16] pl-3 py-2 bg-white/90 backdrop-blur-xs border-r border-y border-stone-200/60 sm:border-r-0 sm:border-y-0 rounded-sm">
                  <h3 className="font-cyber font-black text-xs text-stone-900">GOLDEN NEEDLE BLADES</h3>
                  <p className="text-[11px] text-stone-500 mt-0.5 font-semibold sm:font-medium">Dual custom long needle alloy spikes crafted for target pressure point neutralization.</p>
                </div>
              </div>
              <div className="col-span-12 lg:col-span-4 lg:col-start-9 space-y-3 max-w-xs lg:text-right ml-auto lg:ml-0">
                <div className="border-r-2 border-stone-900 pr-3 py-2 bg-white/90 backdrop-blur-xs text-right border-l border-y border-stone-200/60 sm:border-l-0 sm:border-y-0 rounded-sm">
                  <h3 className="font-cyber font-black text-xs text-stone-900">TACTICAL VANITY AMBUSH</h3>
                  <p className="text-[11px] text-stone-500 mt-0.5 font-semibold sm:font-medium">Concealed blade system fitted perfectly inside standard cosmetic items for close ambushes.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {activeSection === 'garden' && (
            <div className="animate-page-garden grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start w-full my-auto z-20 pb-12 lg:pb-0">
              ...
              <div className="col-span-12 lg:col-span-4 lg:col-start-9 max-w-xs bg-white/90 backdrop-blur-xs p-4 border border-stone-200/60 text-left lg:text-right ml-auto lg:ml-0 rounded-sm">
                <span className="text-[9px] font-cyber text-[#FF2E16] font-black tracking-widest block mb-1">SYSTEM WARNING</span>
                <p className="text-[11px] text-stone-500 font-semibold sm:font-medium">Encryption active. Any attempts to export Garden agency log databases will trigger a manual system wipe.</p>
              </div>
            </div>
          )}
      ...
      >
        <div className="mb-12 space-y-2 border-b border-stone-200 pb-6">
          ...
          <div className="flex justify-between items-end">
            ...
            <span className="text-stone-400 font-cyber text-[10px] tracking-widest hidden sm:block">
              AUTH_CODE: GARDEN.SRC.09
            </span>
          </div>
        </div>
          ...
          {[
            {
              ...
              subtitle: "CRUISE SHIP DEFENSE",
              description: "High-stakes escort mission aboard the Princess Lorelei. Successfully neutralized several corporate bounty hunters targeting key political assets.",
              status: "SUCCESSFUL",
              statusColor: "text-emerald-500"
            },
            {
              id: "02",
              title: "PROJECT RED DAWN",
              subtitle: "INTELLIGENCE EMBEDDING",
              description: "Long-term undercover embedding under city hall administration. Seamlessly maintained perfect bureaucratic coverage while carrying out state purges.",
              status: "ACTIVE COVER",
              statusColor: "text-[#FF2E16]"
            },
            {
              id: "03",
              title: "PROJECT THORN GARDEN",
              subtitle: "TRAITOR CLEANUP FORCE",
              description: "Executed high-precision pressure point targeting on major underground arms dealers threatening Eastern peace protocols.",
              status: "COMPLETED",
              statusColor: "text-emerald-500"
            }
          ].map((project, idx) => (
            <div 
              key={idx} 
              className="group border border-stone-200 p-6 flex flex-col justify-between h-[320px] transition-all duration-500 hover:border-[#FF2E16] hover:shadow-lg bg-white relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-2 h-2 bg-stone-300 group-hover:bg-[#FF2E16] transition-colors"></div>
              
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="font-cyber font-black text-xs text-stone-400 group-hover:text-[#FF2E16] transition-colors">
                    SYS.LOG//0{project.id}
                  </span>
                  <span className={`text-[9px] font-cyber tracking-widest font-bold px-2 py-0.5 bg-stone-50 border border-stone-200/60 ${project.statusColor}`}>
                    {project.status}
                  </span>
                </div>
                <div>
                  <h3 className="font-cyber font-black text-lg text-stone-950 tracking-tight">
                    {project.title}
                  </h3>
                  <p className="text-[10px] font-cyber tracking-widest text-[#FF2E16] font-bold mt-0.5">
                    {project.subtitle}
                  </p>
                </div>
              ...
              <div className="border-t border-stone-100 pt-4 flex justify-between items-center text-[10px] font-cyber text-stone-400">
                <span>COORD: 34.5° N // 12.1° E</span>
                <span className="font-bold text-stone-900 group-hover:translate-x-1 transition-transform">VIEW FILES &rarr;</span>
              </div>
            </div>
          ))}
        </div>

        <div className="mt-12 flex justify-between items-center text-[10px] font-cyber text-stone-400">
          <div className="flex items-center gap-4">
            <div className="w-8 h-[1px] bg-stone-300"></div>
            <span>EST. DIRECTIVE SYSTEM</span>
          </div>
